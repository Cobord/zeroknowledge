...
pub trait PeggyProbe {
    ...
    async fn ask_peggy_2(&self) -> Self::PeggyGaveThis1;
}
...
where 
    ...
    PeggyProbing: PeggyProbe<PeggyGaveThis1 = PeggyResponse1,PeggyGaveThis2 = PeggyResponse2, AuxData = AuxData>
{
    asker: PeggyProbing
}

impl<PeggyResponse1, PeggyResponse2, PeggyProbing, AuxData> Victor<PeggyResponse1, PeggyResponse2, PeggyProbing, AuxData>
where
    PeggyResponse1: PeggyResponsable<AuxData = AuxData>,
    PeggyResponse2: PeggyResponsable<AuxData = AuxData>,
    PeggyProbing: PeggyProbe<PeggyGaveThis1 = PeggyResponse1,PeggyGaveThis2 = PeggyResponse2, AuxData = AuxData>
{
    ...
    #[allow(dead_code)]
    pub async fn new_from_peggy(peggy: &Peggy<AuxData,PeggyResponse1,PeggyResponse2,PeggyProbing>) -> Self {
        Self::new(peggy.give_victor_interface().await)
    }

    async fn do_one_round(&self) -> bool {
    ...
    pub async fn peggy_does_know(&self,rounds_to_do: NonZeroU8, current_confidence: u8) -> Result<NonZeroU8,PeggyDoesntKnowSoDontTellPeggy> {
