...
where 
    ...
    MyInterface: PeggyProbe<AuxData = AuxData,PeggyGaveThis1=PeggyGaveThis1,PeggyGaveThis2=PeggyGaveThis2>,
{
    z0: PhantomData<MyInterface>,
}

impl<AuxData,PeggyGaveThis1,PeggyGaveThis2,MyInterface> Peggy<AuxData,PeggyGaveThis1,PeggyGaveThis2,MyInterface>
where 
    PeggyGaveThis1: PeggyResponsable<AuxData=AuxData>,
    PeggyGaveThis2: PeggyResponsable<AuxData=AuxData>,
    MyInterface: PeggyProbe<AuxData = AuxData,PeggyGaveThis1=PeggyGaveThis1,PeggyGaveThis2=PeggyGaveThis2>,
